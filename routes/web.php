...
Route::middleware(['auth','role:admin'])->group(function(){
    ...
    Route::controller(ClientController::class)->group(function(){
       Route::get('/all/client/post','AllClient')->name('all.client');
       Route::get('/add/client/post','AddClient')->name('add.client');
       Route::post('/store/client/post','StoreClient')->name('store.client');
    ...
    Route::controller(TeamController::class)->group(function(){
      ...
      Route::get('/store/team/{id}','EditTeam')->name('edit.team');
    ...
    Route::controller(CompanyController::class)->group(function(){
      ...
      Route::post('/store/company','StoreCompany')->name('store.company.post');
    });
...
Route::get('/client/deatils/{id}',[IndexController::class,'ClientDetails'])->name('client.details');