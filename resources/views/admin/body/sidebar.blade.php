            ...
            <ul id="side-menu">
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarEcommerce">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('all.slider') }}">All Slider Images</a>
                            </li>
                            <li>
                                <a href="{{ route('add.slider.gallery') }}">Add Slider</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="service">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('all.service.post') }}">All Service Post</a>
                            </li>
                            <li>
                                <a href="{{ route('add.service.post') }}">Add News Post</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="service">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('all.testi.post') }}">All Testimonial Post</a>
                            </li>
                            <li>
                                <a href="{{ route('add.testi.post') }}">Add Testimonial Post</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="service">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('all.client') }}">All Client</a>
                            </li>
                            <li>
                                <a href="{{ route('add.client') }}">Add Client Post</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="team">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('add.team') }}">Add Team Post</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="company">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('all.team') }}">All Company</a>
                            </li>
                            <li>
