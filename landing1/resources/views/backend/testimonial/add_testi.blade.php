                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add Testimonial Post</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Add Testimonial Post</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('store.testi.post') }}" enctype="multipart/form-data">
                                @csrf
