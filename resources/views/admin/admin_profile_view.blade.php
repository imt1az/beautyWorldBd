                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="text-start mt-3">
                            ...
                            <p class="text-muted mb-2 font-13"><strong>Mobile :</strong><span class="ms-2">{{ $admindata->mobile }}</span></p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name='usename' class="form-control" id="firstname" value={{ $admindata->username }}>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name='email' class="form-control"  value={{ $admindata->phone }}>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="lastname" class="form-label">Last Name</label>
                                                <input type="email" name="email" class="form-control" id="" value={{ $admindata->email }}>
                                            </div>
                                        </div> <!-- end col -->
