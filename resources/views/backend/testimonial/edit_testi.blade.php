                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('update.testi.post') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input type="text" value="{{ $testi->name }}" name="name" class="form-control" id="inputEmail4">
                                    </div>
                                    {{-- Image --}}
                                    <div class="form-group col-md-6 mb-3">
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input type="text" value="{{ $testi->designation }}" name="designation" class="form-control" id="inputEmail4">
                                    </div>

                                    <div class="form-group col-md-6 col-md-12 mb-3">
                                        <label for="inputEmail4" class="form-label">Details</label>
                                        <textarea name="details">{!! $testi->details !!}</textarea>
                                    </div>
